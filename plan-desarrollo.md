...
**Lo que NO se ha tocado todavía de H6**: objetivos de misión que pidan explícitamente vender al Falsificador/clan rival o capturar prisioneros (el mecanismo ya existe, ver abajo, falta engancharlo a una misión concreta), desglose de contribución de la Taberna (ahora desbloqueable). Los diálogos de NPCs (tabernera, viejo maestro, usurero, pescador) ya están hechos (`NetworkManager.misiones_completadas`).
