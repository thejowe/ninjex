...
**Lo que NO se ha tocado todavía de H6**: objetivos de misión que pidan explícitamente vender al Falsificador/clan rival o capturar prisioneros (el mecanismo ya existe, ver abajo, falta engancharlo a una misión concreta), historia/diálogos de NPCs más allá del prólogo, desglose de contribución de la Taberna (ahora desbloqueable).
